...
export default async function CustomPage() {
  ...
  // Merchant picker options: name + total spend (purchases only), most-spent first.
  ...
  return (
    <AppShell>
      <div className="mb-5">
        <h1 className="text-xl font-bold tracking-tight">Custom</h1>
        <p className="text-sm text-[var(--muted)]">
          Build, save, and pin your own line charts — mix any categories and merchants to find
          where to spend less.
        </p>
      </div>
